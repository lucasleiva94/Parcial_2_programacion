...
def mostrar_rankings(pantalla: pygame.Surface, cola_eventos: list[pygame.event.Event], partidas: list[dict]) -> str:
    retorno = "rankings"
    ...
    mostrar_texto(pantalla, f"TOP 10:", (80, 100), FUENTE_VOLUMEN, COLOR_NEGRO)
    pos_y = 150
